...
import fpt.edu.vn.perfumeshop.activities.AdminActivity;
    ...
    protected void onStart() {
        ...
        if (firebaseUser != null) {
            ...
            if (email.equals(AppConstants.ADMIN_ACCOUNT)) {
                ...
                startActivity(new Intent(SignInActivity.this, PerfumesList.class));
                finish();
            }
        }
    }
            ...
            call.enqueue(new Callback<Customer[]>() {
                ...
                public void onResponse(Call<Customer[]> call, Response<Customer[]> response) {
                    ...
                    if (customer.getEmail().equals(AppConstants.ADMIN_ACCOUNT)) {
                        ...
                        Intent intent = new Intent(SignInActivity.this, PerfumesList.class);
