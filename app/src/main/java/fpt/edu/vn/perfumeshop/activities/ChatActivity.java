...
import fpt.edu.vn.perfumeshop.PerfumesList;
import fpt.edu.vn.perfumeshop.R;
import fpt.edu.vn.perfumeshop.SignInActivity;
import fpt.edu.vn.perfumeshop.ViewCartActivity;
import fpt.edu.vn.perfumeshop.ViewMapActivity;
import fpt.edu.vn.perfumeshop.adapters.MessageAdapter;
...
public class ChatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recieverDatabaseReference = FirebaseDatabase.getInstance()
                .getReference(AppConstants.CHAT_DB).child(receiverRoom);
        ...
        bottomNavigationView.setOnItemSelectedListener(item -> {
            if (item.getItemId() == R.id.menu_home) {
                startActivity(new Intent(ChatActivity.this, PerfumesList.class));
            }
